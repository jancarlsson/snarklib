#ifndef _SNARKLIB_EC_MNT6_GROUP_CURVE_HPP_
#define _SNARKLIB_EC_MNT6_GROUP_CURVE_HPP_
...
class MNT6_GroupCurve : public ECInitGroups<N, MODULUS_R, MODULUS_Q>
{
...
public:
    ...
    static Fq3 mul_by_a(const Fq3& elt) {
        return Fq3(twist_mul_by_a_c0()[0] * elt[1],
                   twist_mul_by_a_c1()[0] * elt[2],
                   twist_mul_by_a_c2()[0] * elt[0]);
    }
    ...
    static Fq3 mul_by_coeff_a(const Fq3& elt) {
    ...
    static Fq3 mul_by_coeff_b(const Fq3& elt) {
    ...
    static Fq coeff_b() {
        return Fq("106700080510851735677967319632585352256454251201367587890185989362936000262606668469523074");
    }
    ...
    static Fq3 twist_coeff_b() {
        return {
            (coeff_b() * Fq3::params.non_residue())[0],
            Fq::zero()[0],
            Fq::zero()[0]
        };
    }
    ...
    static Fq twist_mul_by_b_c0() {
        return coeff_b() * Fq3::params.non_residue();
    }
    ...
    static Fq twist_mul_by_b_c2() {
        return coeff_b() * Fq3::params.non_residue();
    }

    static Fq twist_mul_by_q_X() {
        return Fq("4183387201740296620308398334599285547820769823264541783190415909159130177461911693276180");
    }

    static Fq twist_mul_by_q_Y() {
        return Fq("475922286169261325753349249653048451545124878552823515553267735739164647307408490559963136");
    }
